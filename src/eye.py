...
class Eye:
    ...
    def get_direction(self) -> Direction:
        ...
        if (x_start < x_current + self.middle_block[0] and x_start > x_current - self.middle_block[0] and
            y_start < y_current + self.middle_block[1] and y_start > y_current - self.middle_block[1]):
